...
-- ServerStorage.ScreenGui
G2L["1"] = Instance.new("ScreenGui", gethui and gethui() or game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui"));
...
-- ServerStorage.ScreenGui.LocalScript
G2L["2"] = Instance.new("LocalScript", G2L["1"]);



-- ServerStorage.ScreenGui.LocalScript.Yo
...
-- ServerStorage.ScreenGui.LocalScript.Yo.UICorner
G2L["4"] = Instance.new("UICorner", G2L["3"]);
G2L["4"]["CornerRadius"] = UDim.new(0, 9);


-- ServerStorage.ScreenGui.LocalScript.Yo.UIListLayout
...
-- ServerStorage.ScreenGui.LocalScript.Yo.UIPadding
...
-- ServerStorage.ScreenGui.LocalScript.Yo.Title
...
G2L["7"]["TextDirection"] = Enum.TextDirection.LeftToRight;
G2L["7"]["FontFace"] = Font.new([[rbxassetid://16658221428]], Enum.FontWeight.Medium, Enum.FontStyle.Normal);
...
-- ServerStorage.ScreenGui.LocalScript.Yo.Delete
...
G2L["8"]["ImageColor3"] = Color3.fromRGB(208, 208, 208);
G2L["8"]["Selectable"] = false;
G2L["8"]["Image"] = [[rbxassetid://122962777517764]];
G2L["8"]["Size"] = UDim2.new(0.05509, 0, 1, 0);
G2L["8"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["8"]["Name"] = [[Delete]];
G2L["8"]["Position"] = UDim2.new(0.46157, 0, 0, 0);


-- ServerStorage.ScreenGui.LocalScript.Yo.UIStroke
G2L["9"] = Instance.new("UIStroke", G2L["3"]);
G2L["9"]["Transparency"] = 0.95;
G2L["9"]["Thickness"] = 3;
G2L["9"]["Color"] = Color3.fromRGB(232, 229, 255);
G2L["9"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;


-- ServerStorage.ScreenGui.LocalScript.SearchTemplate
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Title
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.UICorner
G2L["c"] = Instance.new("UICorner", G2L["a"]);
G2L["c"]["CornerRadius"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.UIListLayout
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.UIStroke
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.UIPadding
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Misc
G2L["10"] = Instance.new("Folder", G2L["a"]);
G2L["10"]["Name"] = [[Misc]];


-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Misc.Thumbnail
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Misc.Thumbnail.UICorner
G2L["12"] = Instance.new("UICorner", G2L["11"]);
G2L["12"]["CornerRadius"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Misc.Thumbnail.UIGradient
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Misc.Panel
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Misc.Panel.UIListLayout
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Misc.Panel.UICorner
G2L["16"] = Instance.new("UICorner", G2L["14"]);
G2L["16"]["CornerRadius"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Misc.Panel.Spacer1
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Misc.Panel.Spacer1.UICorner
G2L["18"] = Instance.new("UICorner", G2L["17"]);
G2L["18"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Misc.Panel.Execute
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Misc.Panel.Execute.Icon
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Misc.Panel.Save
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Misc.Panel.Save.Icon
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Misc.Panel.UIScale
G2L["1d"] = Instance.new("UIScale", G2L["14"]);
G2L["1d"]["Scale"] = 0.8;


-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Misc.Panel.UIPadding
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Tags
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Tags.UIListLayout
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Tags.Key
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Tags.Key.UIPadding
G2L["22"] = Instance.new("UIPadding", G2L["21"]);
G2L["22"]["PaddingRight"] = UDim.new(0, 12);
G2L["22"]["PaddingLeft"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Tags.Key.UICorner
G2L["23"] = Instance.new("UICorner", G2L["21"]);



-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Tags.Paid
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Tags.Paid.UIPadding
G2L["25"] = Instance.new("UIPadding", G2L["24"]);
G2L["25"]["PaddingRight"] = UDim.new(0, 12);
G2L["25"]["PaddingLeft"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Tags.Paid.UICorner
G2L["26"] = Instance.new("UICorner", G2L["24"]);



-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Tags.Patched
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Tags.Patched.UIPadding
G2L["28"] = Instance.new("UIPadding", G2L["27"]);
G2L["28"]["PaddingRight"] = UDim.new(0, 12);
G2L["28"]["PaddingLeft"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Tags.Patched.UICorner
G2L["29"] = Instance.new("UICorner", G2L["27"]);



-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Tags.Universal
...
-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Tags.Universal.UIPadding
G2L["2b"] = Instance.new("UIPadding", G2L["2a"]);
G2L["2b"]["PaddingRight"] = UDim.new(0, 12);
G2L["2b"]["PaddingLeft"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.LocalScript.SearchTemplate.Tags.Universal.UICorner
G2L["2c"] = Instance.new("UICorner", G2L["2a"]);



-- ServerStorage.ScreenGui.LocalScript.SaveTemplate
...
-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.UICorner
G2L["2e"] = Instance.new("UICorner", G2L["2d"]);
G2L["2e"]["CornerRadius"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.UIListLayout
...
-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.UIStroke
...
-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.UIPadding
...
-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.Misc
G2L["32"] = Instance.new("Folder", G2L["2d"]);
G2L["32"]["Name"] = [[Misc]];


-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.Misc.Panel
...
-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.Misc.Panel.UIListLayout
...
-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.Misc.Panel.UICorner
G2L["35"] = Instance.new("UICorner", G2L["33"]);
G2L["35"]["CornerRadius"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.Misc.Panel.Spacer1
...
-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.Misc.Panel.Spacer1.UICorner
G2L["37"] = Instance.new("UICorner", G2L["36"]);
G2L["37"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.Misc.Panel.Execute
...
-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.Misc.Panel.Execute.Icon
...
-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.Misc.Panel.Delete
...
-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.Misc.Panel.Delete.Icon
...
-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.Misc.Panel.UIScale
G2L["3c"] = Instance.new("UIScale", G2L["33"]);
G2L["3c"]["Scale"] = 0.8;


-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.Misc.Panel.UIPadding
...
-- ServerStorage.ScreenGui.LocalScript.SaveTemplate.Title
...
-- ServerStorage.ScreenGui.Main.Title
...
-- ServerStorage.ScreenGui.Main.Title.TextLabel
...
-- ServerStorage.ScreenGui.Main.Title.TextLabel.UIPadding
G2L["42"] = Instance.new("UIPadding", G2L["41"]);
G2L["42"]["PaddingLeft"] = UDim.new(0, 15);


-- ServerStorage.ScreenGui.Main.Title.UIListLayout
...
-- ServerStorage.ScreenGui.Main.Title.TextLabel1.UIPadding
G2L["46"] = Instance.new("UIPadding", G2L["45"]);
G2L["46"]["PaddingLeft"] = UDim.new(0, 15);


-- ServerStorage.ScreenGui.Main.Leftside
...
-- ServerStorage.ScreenGui.Main.Leftside.UIListLayout
...
-- ServerStorage.ScreenGui.Main.Leftside.UIPadding
...
-- ServerStorage.ScreenGui.Main.Leftside.Close
...
-- ServerStorage.ScreenGui.Main.Leftside.Close.UICorner
G2L["4b"] = Instance.new("UICorner", G2L["4a"]);
G2L["4b"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Leftside.Close.ImageLabel
...
-- ServerStorage.ScreenGui.Main.Leftside.Close.ImageLabel.UIScale
G2L["4d"] = Instance.new("UIScale", G2L["4c"]);
G2L["4d"]["Scale"] = 0.5;


-- ServerStorage.ScreenGui.Main.Leftside.Close.ImageLabel1
...
-- ServerStorage.ScreenGui.Main.Leftside.Close.UIAspectRatioConstraint1
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.UICorner
G2L["51"] = Instance.new("UICorner", G2L["50"]);
G2L["51"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Leftside.Nav.UIStroke
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Editor
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Editor.SizeRatio
G2L["55"] = Instance.new("UIAspectRatioConstraint", G2L["54"]);
G2L["55"]["DominantAxis"] = Enum.DominantAxis.Height;
G2L["55"]["Name"] = [[SizeRatio]];


-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Editor.UICorner
G2L["56"] = Instance.new("UICorner", G2L["54"]);
G2L["56"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Editor.Icon
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Editor.Icon.UIScale
G2L["58"] = Instance.new("UIScale", G2L["57"]);
G2L["58"]["Scale"] = 0.5;


-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Home
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Home.Icon.UIScale
G2L["5d"] = Instance.new("UIScale", G2L["5c"]);
G2L["5d"]["Scale"] = 0.5;


-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Saved
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Saved.SizeRatio
G2L["5f"] = Instance.new("UIAspectRatioConstraint", G2L["5e"]);
G2L["5f"]["DominantAxis"] = Enum.DominantAxis.Height;
G2L["5f"]["Name"] = [[SizeRatio]];


-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Saved.UICorner
G2L["60"] = Instance.new("UICorner", G2L["5e"]);
G2L["60"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Saved.Icon
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Saved.Icon.UIScale
G2L["62"] = Instance.new("UIScale", G2L["61"]);
G2L["62"]["Scale"] = 0.5;


-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Search
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Search.SizeRatio
G2L["64"] = Instance.new("UIAspectRatioConstraint", G2L["63"]);
G2L["64"]["DominantAxis"] = Enum.DominantAxis.Height;
G2L["64"]["Name"] = [[SizeRatio]];


-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Search.UICorner
G2L["65"] = Instance.new("UICorner", G2L["63"]);
G2L["65"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Search.Icon
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Search.Icon.UIScale
G2L["67"] = Instance.new("UIScale", G2L["66"]);
G2L["67"]["Scale"] = 0.5;


-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Settings
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Settings.UICorner
G2L["69"] = Instance.new("UICorner", G2L["68"]);
G2L["69"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Settings.Icon
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Settings.Icon.UIScale
G2L["6b"] = Instance.new("UIScale", G2L["6a"]);
G2L["6b"]["Scale"] = 0.5;


-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.Settings.SizeRatio
G2L["6c"] = Instance.new("UIAspectRatioConstraint", G2L["68"]);
G2L["6c"]["DominantAxis"] = Enum.DominantAxis.Height;
G2L["6c"]["Name"] = [[SizeRatio]];


-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.UIListLayout1
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page1.UIPadding1
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.UIPageLayout
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page2
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page2.UIListLayout1
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page2.UIPadding1
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page2.Console
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page2.Console.SizeRatio
G2L["74"] = Instance.new("UIAspectRatioConstraint", G2L["73"]);
G2L["74"]["DominantAxis"] = Enum.DominantAxis.Height;
G2L["74"]["Name"] = [[SizeRatio]];


-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page2.Console.UICorner
G2L["75"] = Instance.new("UICorner", G2L["73"]);
G2L["75"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page2.Console.Icon
...
-- ServerStorage.ScreenGui.Main.Leftside.Nav.Page2.Console.Icon.UIScale
G2L["77"] = Instance.new("UIScale", G2L["76"]);
G2L["77"]["Scale"] = 0.5;


-- ServerStorage.ScreenGui.Main.Pages
...
-- ServerStorage.ScreenGui.Main.Pages.UIPageLayout
...
-- ServerStorage.ScreenGui.Main.Pages.Editor
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Tabs
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Tabs.UIPadding
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Tabs.UIListLayout
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Tabs.Create
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Tabs.Create.UIAspectRatioConstraint
G2L["7f"] = Instance.new("UIAspectRatioConstraint", G2L["7e"]);



-- ServerStorage.ScreenGui.Main.Pages.Editor.Tabs.Create.UICorner
G2L["80"] = Instance.new("UICorner", G2L["7e"]);
G2L["80"]["CornerRadius"] = UDim.new(0, 9);


-- ServerStorage.ScreenGui.Main.Pages.Editor.Tabs.Create.UIStroke
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Editor
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Editor.Input
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Editor.UIListLayout
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Editor.UIPadding
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Editor.UICorner
G2L["86"] = Instance.new("UICorner", G2L["82"]);
G2L["86"]["CornerRadius"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.Main.Pages.Editor.Editor.Lines
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Editor.UIStroke
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.UIListLayout
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.UICorner
G2L["8b"] = Instance.new("UICorner", G2L["89"]);
G2L["8b"]["CornerRadius"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.Spacer1
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.Spacer1.UICorner
G2L["8d"] = Instance.new("UICorner", G2L["8c"]);
G2L["8d"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.Spacer2
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.Spacer2.UICorner
G2L["8f"] = Instance.new("UICorner", G2L["8e"]);
G2L["8f"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.Rename
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.Rename.Icon
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.Paste
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.Paste.Icon
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.ExecuteClipboard
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.ExecuteClipboard.Icon
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.Execute
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.Execute.Icon
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.Save
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.Save.Icon
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.Delete
...
-- ServerStorage.ScreenGui.Main.Pages.Editor.Panel.Delete.Icon
...
-- ServerStorage.ScreenGui.Main.Pages.Search
...
-- ServerStorage.ScreenGui.Main.Pages.Search.UIListLayout
...
-- ServerStorage.ScreenGui.Main.Pages.Search.Scripts
...
-- ServerStorage.ScreenGui.Main.Pages.Search.Scripts.UICorner1
G2L["9f"] = Instance.new("UICorner", G2L["9e"]);
G2L["9f"]["Name"] = [[UICorner1]];
G2L["9f"]["CornerRadius"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.Main.Pages.Search.Scripts.UIStroke1
...
-- ServerStorage.ScreenGui.Main.Pages.Search.Scripts.UIListLayout
G2L["a1"] = Instance.new("UIListLayout", G2L["9e"]);
G2L["a1"]["Padding"] = UDim.new(0, 10);
G2L["a1"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ServerStorage.ScreenGui.Main.Pages.Search.Scripts.UIPadding
...
-- ServerStorage.ScreenGui.Main.Pages.Search.TextBox
...
-- ServerStorage.ScreenGui.Main.Pages.Search.TextBox.UICorner
G2L["a4"] = Instance.new("UICorner", G2L["a3"]);
G2L["a4"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Pages.Search.TextBox.UIStroke1
...
-- ServerStorage.ScreenGui.Main.Pages.Saved.UIListLayout
...
-- ServerStorage.ScreenGui.Main.Pages.Saved.Scripts
...
-- ServerStorage.ScreenGui.Main.Pages.Saved.Scripts.UICorner1
G2L["aa"] = Instance.new("UICorner", G2L["a9"]);
G2L["aa"]["Name"] = [[UICorner1]];
G2L["aa"]["CornerRadius"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.Main.Pages.Saved.Scripts.UIStroke1
...
-- ServerStorage.ScreenGui.Main.Pages.Saved.Scripts.UIListLayout
G2L["ac"] = Instance.new("UIListLayout", G2L["a9"]);
G2L["ac"]["Padding"] = UDim.new(0, 10);
G2L["ac"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ServerStorage.ScreenGui.Main.Pages.Saved.Scripts.UIPadding
...
-- ServerStorage.ScreenGui.Main.Pages.Saved.TextBox
...
-- ServerStorage.ScreenGui.Main.Pages.Saved.TextBox.UICorner
G2L["af"] = Instance.new("UICorner", G2L["ae"]);
G2L["af"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Pages.Saved.TextBox.UIStroke1
...
-- ServerStorage.ScreenGui.Main.Pages.Home.UIListLayout
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Features
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.UICorner
G2L["b7"] = Instance.new("UICorner", G2L["b6"]);
G2L["b7"]["CornerRadius"] = UDim.new(0, 14);


-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.UIStroke
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Title
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Title.TextLabel
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Title.TextLabel.UIPadding
G2L["bb"] = Instance.new("UIPadding", G2L["ba"]);
G2L["bb"]["PaddingLeft"] = UDim.new(0, 15);


-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Title.UIListLayout
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Title.TextLabel1
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Title.TextLabel1.UIPadding
G2L["be"] = Instance.new("UIPadding", G2L["bd"]);
G2L["be"]["PaddingLeft"] = UDim.new(0, 15);


-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Title.UIPadding
G2L["bf"] = Instance.new("UIPadding", G2L["b9"]);
G2L["bf"]["PaddingTop"] = UDim.new(0, 5);


-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.UIListLayout
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Misc
G2L["c1"] = Instance.new("Folder", G2L["b6"]);
G2L["c1"]["Name"] = [[Misc]];


-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Misc.Fade
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Misc.Fade.UIGradient
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Misc.Fade.UICorner
G2L["c4"] = Instance.new("UICorner", G2L["c2"]);
G2L["c4"]["CornerRadius"] = UDim.new(0, 14);


-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Lists
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Lists.A
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Lists.A.UICorner
G2L["c7"] = Instance.new("UICorner", G2L["c6"]);
G2L["c7"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Lists.A.UIStroke
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Lists.A.UIPadding
G2L["c9"] = Instance.new("UIPadding", G2L["c6"]);
G2L["c9"]["PaddingLeft"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Lists.UIListLayout
G2L["ca"] = Instance.new("UIListLayout", G2L["c5"]);
G2L["ca"]["Padding"] = UDim.new(0, 12);
G2L["ca"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ServerStorage.ScreenGui.Main.Pages.Home.Features.RScript.Lists.UIPadding
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Features.UIPageLayout
...
-- ServerStorage.ScreenGui.Main.Pages.Home.UIPadding
G2L["cd"] = Instance.new("UIPadding", G2L["b3"]);
G2L["cd"]["PaddingTop"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.Main.Pages.Home.Key
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Key.UIListLayout
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Key.KeyText
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Key.KeyText.UIPadding
G2L["d1"] = Instance.new("UIPadding", G2L["d0"]);
G2L["d1"]["PaddingLeft"] = UDim.new(0, 15);


-- ServerStorage.ScreenGui.Main.Pages.Home.Key.UIPadding
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Key.UICorner
G2L["d3"] = Instance.new("UICorner", G2L["ce"]);
G2L["d3"]["CornerRadius"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.Main.Pages.Home.Key.UIStroke
G2L["d4"] = Instance.new("UIStroke", G2L["ce"]);
G2L["d4"]["Thickness"] = 2;
G2L["d4"]["Color"] = Color3.fromRGB(126, 255, 126);


-- ServerStorage.ScreenGui.Main.Pages.Home.Key.Duration
...
-- ServerStorage.ScreenGui.Main.Pages.Home.Key.Duration.UIPadding
G2L["d6"] = Instance.new("UIPadding", G2L["d5"]);
G2L["d6"]["PaddingLeft"] = UDim.new(0, 15);


-- ServerStorage.ScreenGui.Main.Pages.Home.Key.Folder
G2L["d7"] = Instance.new("Folder", G2L["ce"]);



-- ServerStorage.ScreenGui.Main.Pages.Home.Key.Folder.Background
...
-- ServerStorage.ScreenGui.Main.Pages.Settings
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.UIListLayout
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UICorner1
G2L["dc"] = Instance.new("UICorner", G2L["db"]);
G2L["dc"]["Name"] = [[UICorner1]];
G2L["dc"]["CornerRadius"] = UDim.new(0, 24);


-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UIStroke1
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UIListLayout
G2L["de"] = Instance.new("UIListLayout", G2L["db"]);
G2L["de"]["Padding"] = UDim.new(0, 10);
G2L["de"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UIPadding
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.AFK
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.AFK.UICorner
G2L["e1"] = Instance.new("UICorner", G2L["e0"]);
G2L["e1"]["CornerRadius"] = UDim.new(0, 18);


-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.AFK.UIListLayout
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.AFK.UIStroke
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.AFK.UIPadding
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.AFK.Title
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.AFK.Main
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.AFK.Main.UICorner
G2L["e7"] = Instance.new("UICorner", G2L["e6"]);
G2L["e7"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.AFK.Main.Button
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.AFK.Main.Button.UICorner
G2L["e9"] = Instance.new("UICorner", G2L["e8"]);
G2L["e9"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.AFK.Main.Button.UIPadding
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.AFK.Main.Button.UIListLayout
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.AFK.Main.Button.Point
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.AFK.Main.Button.Point.UIAspectRatioConstraint
G2L["ed"] = Instance.new("UIAspectRatioConstraint", G2L["ec"]);



-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.AFK.Main.UIAspectRatioConstraint
G2L["ee"] = Instance.new("UIAspectRatioConstraint", G2L["e6"]);
G2L["ee"]["AspectRatio"] = 1.90335;


-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UITransparency
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UITransparency.UICorner
G2L["f0"] = Instance.new("UICorner", G2L["ef"]);
G2L["f0"]["CornerRadius"] = UDim.new(0, 18);


-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UITransparency.UIListLayout
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UITransparency.UIStroke
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UITransparency.UIPadding
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UITransparency.Title
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UITransparency.Main
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UITransparency.Main.UICorner
G2L["f6"] = Instance.new("UICorner", G2L["f5"]);
G2L["f6"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UITransparency.Main.Line
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UITransparency.Main.Line.UICorner
G2L["f8"] = Instance.new("UICorner", G2L["f7"]);
G2L["f8"]["CornerRadius"] = UDim.new(0.3, 0);


-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UITransparency.Main.Line.Interact
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UITransparency.Main.Line.Interact.UICorner
G2L["fa"] = Instance.new("UICorner", G2L["f9"]);
G2L["fa"]["CornerRadius"] = UDim.new(0, 4);


-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UITransparency.Main.Line.Percentage
G2L["fb"] = Instance.new("IntValue", G2L["f7"]);
G2L["fb"]["Name"] = [[Percentage]];


-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UITransparency.Main.Line.Fill
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UITransparency.Main.Line.Fill.UICorner
G2L["fd"] = Instance.new("UICorner", G2L["fc"]);
G2L["fd"]["CornerRadius"] = UDim.new(0.3, 0);


-- ServerStorage.ScreenGui.Main.Pages.Settings.Scripts.UITransparency.Main.UIPadding
G2L["fe"] = Instance.new("UIPadding", G2L["f5"]);
G2L["fe"]["PaddingRight"] = UDim.new(0, 5);
G2L["fe"]["PaddingLeft"] = UDim.new(0, 5);


-- ServerStorage.ScreenGui.Main.Pages.Settings.TextBox
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.TextBox.UICorner
G2L["100"] = Instance.new("UICorner", G2L["ff"]);
G2L["100"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Pages.Settings.TextBox.UIStroke1
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.UIPadding
G2L["102"] = Instance.new("UIPadding", G2L["d9"]);
G2L["102"]["PaddingRight"] = UDim.new(0, 2);
G2L["102"]["PaddingLeft"] = UDim.new(0, 2);


-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc
G2L["103"] = Instance.new("Folder", G2L["d9"]);
G2L["103"]["Name"] = [[Misc]];


-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.ValueSelector
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.ValueSelector.UIGradient
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.ValueSelector.Cursor
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.ValueSelector.Cursor.UICorner
G2L["108"] = Instance.new("UICorner", G2L["107"]);



-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.ValueSelector.Cursor.UIStroke
G2L["109"] = Instance.new("UIStroke", G2L["107"]);
G2L["109"]["Thickness"] = 2;


-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.ValueSelector.UICorner
G2L["10a"] = Instance.new("UICorner", G2L["105"]);
G2L["10a"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.ColorWheel
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.ColorWheel.Cursor
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.ColorWheel.UIAspectRatioConstraint
G2L["10d"] = Instance.new("UIAspectRatioConstraint", G2L["10b"]);



-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.Frame
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.Frame.UICorner
G2L["10f"] = Instance.new("UICorner", G2L["10e"]);
G2L["10f"]["CornerRadius"] = UDim.new(0, 24);


-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.Frame.TextLabel
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.UICorner
G2L["111"] = Instance.new("UICorner", G2L["104"]);
G2L["111"]["CornerRadius"] = UDim.new(0, 24);


-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.UIStroke
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.UIPadding
G2L["113"] = Instance.new("UIPadding", G2L["104"]);
G2L["113"]["PaddingTop"] = UDim.new(0, 12);
G2L["113"]["PaddingBottom"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.Close
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.Close.UICorner
G2L["115"] = Instance.new("UICorner", G2L["114"]);
G2L["115"]["CornerRadius"] = UDim.new(0, 18);


-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.Close.ImageLabel
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.Close.ImageLabel.UIScale
G2L["117"] = Instance.new("UIScale", G2L["116"]);
G2L["117"]["Scale"] = 0.5;


-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.Close.UIAspectRatioConstraint1
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.Confirm
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.Confirm.UICorner
G2L["11a"] = Instance.new("UICorner", G2L["119"]);
G2L["11a"]["CornerRadius"] = UDim.new(0, 18);


-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.Confirm.UIAspectRatioConstraint1
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.Confirm.ImageLabel
...
-- ServerStorage.ScreenGui.Main.Pages.Settings.Misc.ColorEditor.Confirm.ImageLabel.UIScale
G2L["11d"] = Instance.new("UIScale", G2L["11c"]);
G2L["11d"]["Scale"] = 0.5;


-- ServerStorage.ScreenGui.Main.EnableFrame
...
-- ServerStorage.ScreenGui.Main.EnableFrame.UICorner
G2L["11f"] = Instance.new("UICorner", G2L["11e"]);
G2L["11f"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Main.EnableFrame.Glow
...
-- ServerStorage.ScreenGui.Key
G2L["124"] = Instance.new("Frame", G2L["1"]);
G2L["124"]["ZIndex"] = 999999999;
...
-- ServerStorage.ScreenGui.Key.Main
G2L["125"] = Instance.new("Frame", G2L["124"]);
G2L["125"]["ZIndex"] = 999999999;
G2L["125"]["BorderSizePixel"] = 0;
G2L["125"]["BackgroundColor3"] = Color3.fromRGB(26, 27, 32);
G2L["125"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
G2L["125"]["Size"] = UDim2.new(0.5, 0, 0.5, 0);
G2L["125"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);
G2L["125"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["125"]["Name"] = [[Main]];


-- ServerStorage.ScreenGui.Key.Main.UICorner
G2L["126"] = Instance.new("UICorner", G2L["125"]);
G2L["126"]["CornerRadius"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.Key.Main.UIListLayout
G2L["127"] = Instance.new("UIListLayout", G2L["125"]);
G2L["127"]["HorizontalAlignment"] = Enum.HorizontalAlignment.Center;
G2L["127"]["Padding"] = UDim.new(0, 12);
G2L["127"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ServerStorage.ScreenGui.Key.Main.TextLabel
G2L["128"] = Instance.new("TextLabel", G2L["125"]);
G2L["128"]["TextWrapped"] = true;
G2L["128"]["ZIndex"] = 999999999;
...
G2L["128"]["Size"] = UDim2.new(0.9, 0, 0.13776, 0);
G2L["128"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["128"]["Text"] = [[Please redeem your key to continue using Punk X]];
G2L["128"]["LayoutOrder"] = -1;
G2L["128"]["Position"] = UDim2.new(0.2195, 0, 0, 0);


-- ServerStorage.ScreenGui.Key.Main.UIPadding
G2L["129"] = Instance.new("UIPadding", G2L["125"]);
G2L["129"]["PaddingTop"] = UDim.new(0, 12);


-- ServerStorage.ScreenGui.Key.Main.Key
G2L["12a"] = Instance.new("TextBox", G2L["125"]);
G2L["12a"]["Name"] = [[Key]];
G2L["12a"]["PlaceholderColor3"] = Color3.fromRGB(179, 179, 179);
G2L["12a"]["ZIndex"] = 999999999;
G2L["12a"]["BorderSizePixel"] = 0;
G2L["12a"]["TextSize"] = 18;
G2L["12a"]["TextColor3"] = Color3.fromRGB(255, 255, 255);
G2L["12a"]["BackgroundColor3"] = Color3.fromRGB(26, 27, 32);
G2L["12a"]["FontFace"] = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Medium, Enum.FontStyle.Normal);
G2L["12a"]["ClearTextOnFocus"] = false;
G2L["12a"]["PlaceholderText"] = [[Key]];
G2L["12a"]["Size"] = UDim2.new(0.9, 0, 0.23469, 0);
G2L["12a"]["Position"] = UDim2.new(0.05, 0, 0.18338, 0);
G2L["12a"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["12a"]["Text"] = [[]];
G2L["12a"]["BackgroundTransparency"] = 1;


-- ServerStorage.ScreenGui.Key.Main.Key.UIStroke
G2L["12b"] = Instance.new("UIStroke", G2L["12a"]);
G2L["12b"]["Transparency"] = 0.95;
G2L["12b"]["Thickness"] = 3;
G2L["12b"]["Color"] = Color3.fromRGB(232, 229, 255);
G2L["12b"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;


-- ServerStorage.ScreenGui.Key.Main.Key.UICorner
G2L["12c"] = Instance.new("UICorner", G2L["12a"]);
G2L["12c"]["CornerRadius"] = UDim.new(0, 6);


-- ServerStorage.ScreenGui.Key.Main.Join
G2L["12d"] = Instance.new("TextButton", G2L["125"]);
G2L["12d"]["RichText"] = true;
G2L["12d"]["BorderSizePixel"] = 0;
G2L["12d"]["TextSize"] = 14;
G2L["12d"]["TextColor3"] = Color3.fromRGB(136, 136, 136);
G2L["12d"]["BackgroundColor3"] = Color3.fromRGB(77, 174, 55);
G2L["12d"]["FontFace"] = Font.new([[rbxassetid://16658221428]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
G2L["12d"]["ZIndex"] = 999999999;
G2L["12d"]["BackgroundTransparency"] = 1;
G2L["12d"]["Size"] = UDim2.new(1, 0, 0.10204, 0);
G2L["12d"]["LayoutOrder"] = 1;
G2L["12d"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["12d"]["Text"] = [[<u>Or Join Roblox</u>]];
G2L["12d"]["Name"] = [[Join]];
G2L["12d"]["Position"] = UDim2.new(0.2195, 0, 0.55448, 0);


-- ServerStorage.ScreenGui.Key.Main.Join.UICorner
G2L["12e"] = Instance.new("UICorner", G2L["12d"]);
G2L["12e"]["CornerRadius"] = UDim.new(0, 6);


-- ServerStorage.ScreenGui.Key.Main.Button
G2L["12f"] = Instance.new("Frame", G2L["125"]);
G2L["12f"]["BorderSizePixel"] = 0;
G2L["12f"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
G2L["12f"]["Size"] = UDim2.new(1, 0, 0.173, 0);
G2L["12f"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["12f"]["Name"] = [[Button]];


-- ServerStorage.ScreenGui.Key.Main.Button.GetKey
G2L["130"] = Instance.new("TextButton", G2L["12f"]);
G2L["130"]["BorderSizePixel"] = 0;
G2L["130"]["TextSize"] = 14;
G2L["130"]["TextColor3"] = Color3.fromRGB(255, 255, 255);
G2L["130"]["BackgroundColor3"] = Color3.fromRGB(26, 27, 32);
G2L["130"]["FontFace"] = Font.new([[rbxassetid://16658221428]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
G2L["130"]["ZIndex"] = 999999999;
G2L["130"]["Size"] = UDim2.new(0.32721, 0, 0.17347, 0);
G2L["130"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["130"]["Text"] = [[Get key]];
G2L["130"]["Name"] = [[GetKey]];
G2L["130"]["Position"] = UDim2.new(0.22715, 0, 0.50288, 0);


-- ServerStorage.ScreenGui.Key.Main.Button.GetKey.UICorner
G2L["131"] = Instance.new("UICorner", G2L["130"]);
G2L["131"]["CornerRadius"] = UDim.new(0, 6);


-- ServerStorage.ScreenGui.Key.Main.Button.GetKey.UIStroke
G2L["132"] = Instance.new("UIStroke", G2L["130"]);
G2L["132"]["Transparency"] = 0.9;
G2L["132"]["Thickness"] = 3;
G2L["132"]["Color"] = Color3.fromRGB(255, 255, 255);
G2L["132"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;


-- ServerStorage.ScreenGui.Key.Main.Button.UIListLayout
G2L["133"] = Instance.new("UIListLayout", G2L["12f"]);
G2L["133"]["HorizontalAlignment"] = Enum.HorizontalAlignment.Center;
G2L["133"]["HorizontalFlex"] = Enum.UIFlexAlignment.Fill;
G2L["133"]["VerticalFlex"] = Enum.UIFlexAlignment.Fill;
G2L["133"]["Padding"] = UDim.new(0, 12);
G2L["133"]["SortOrder"] = Enum.SortOrder.LayoutOrder;
G2L["133"]["FillDirection"] = Enum.FillDirection.Horizontal;


-- ServerStorage.ScreenGui.Key.Main.Button.Redeem
G2L["134"] = Instance.new("TextButton", G2L["12f"]);
G2L["134"]["BorderSizePixel"] = 0;
G2L["134"]["TextSize"] = 14;
G2L["134"]["TextColor3"] = Color3.fromRGB(255, 255, 255);
G2L["134"]["BackgroundColor3"] = Color3.fromRGB(77, 174, 55);
G2L["134"]["FontFace"] = Font.new([[rbxassetid://16658221428]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
G2L["134"]["ZIndex"] = 999999999;
G2L["134"]["Size"] = UDim2.new(0.32721, 0, 0.17347, 0);
G2L["134"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["134"]["Text"] = [[Redeem]];
G2L["134"]["Name"] = [[Redeem]];
G2L["134"]["Position"] = UDim2.new(0.22715, 0, 0.50288, 0);


-- ServerStorage.ScreenGui.Key.Main.Button.Redeem.UICorner
G2L["135"] = Instance.new("UICorner", G2L["134"]);
G2L["135"]["CornerRadius"] = UDim.new(0, 6);


-- ServerStorage.ScreenGui.Key.Main.Button.Redeem.UIStroke
G2L["136"] = Instance.new("UIStroke", G2L["134"]);
G2L["136"]["Transparency"] = 0.9;
G2L["136"]["Thickness"] = 3;
G2L["136"]["Color"] = Color3.fromRGB(14, 255, 0);
G2L["136"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;


-- ServerStorage.ScreenGui.Key.Main.Button.UIPadding
G2L["137"] = Instance.new("UIPadding", G2L["12f"]);
G2L["137"]["PaddingRight"] = UDim.new(0, 18);
G2L["137"]["PaddingLeft"] = UDim.new(0, 18);


-- ServerStorage.ScreenGui.Open
...
-- ServerStorage.ScreenGui.Open.Icon
...
-- ServerStorage.ScreenGui.Open.Outline
...
-- ServerStorage.ScreenGui.Open.Outline.UICorner
G2L["13b"] = Instance.new("UICorner", G2L["13a"]);
G2L["13b"]["CornerRadius"] = UDim.new(1, 0);


-- ServerStorage.ScreenGui.Open.Outline.UIStroke
...
-- ServerStorage.ScreenGui.Open.UIAspectRatioConstraint
...
local script = G2L["2"];
	...
	local print = function(...) end -- disabled print to prevent anticheat of stupid games
	...
	-- Store original properties for each frame
	...
	local function scaleUIElement(element, storeOnly)
		...
		-- If storeOnly mode, don't scale yet
		if storeOnly then return end
	
		-- Now scale the element
		...
		if element:IsA("UIListLayout") then
			-- Scale UIListLayout padding
			element.Padding = UDim.new(
				OriginalProperties[element].Padding.Scale * Scale,
				OriginalProperties[element].Padding.Offset * Scale
			)
	
		elseif element:IsA("UIPadding") then
			-- Scale UIPadding all sides
			element.PaddingTop = UDim.new(
				OriginalProperties[element].PaddingTop.Scale * Scale,
				OriginalProperties[element].PaddingTop.Offset * Scale
			)
			element.PaddingBottom = UDim.new(
				OriginalProperties[element].PaddingBottom.Scale * Scale,
				OriginalProperties[element].PaddingBottom.Offset * Scale
			)
			element.PaddingLeft = UDim.new(
				OriginalProperties[element].PaddingLeft.Scale * Scale,
				OriginalProperties[element].PaddingLeft.Offset * Scale
			)
			element.PaddingRight = UDim.new(
				OriginalProperties[element].PaddingRight.Scale * Scale,
				OriginalProperties[element].PaddingRight.Offset * Scale
			)
	
		elseif element:IsA("UICorner") then
			-- Scale UICorner radius
			element.CornerRadius = UDim.new(
				OriginalProperties[element].CornerRadius.Scale * Scale,
				OriginalProperties[element].CornerRadius.Offset * Scale
			)
	
		else
			-- Scale Frame/GuiObject size
			...
			-- Only scale position if there's no UIListLayout
			local hasUIList = element.Parent and element.Parent:FindFirstChildOfClass("UIListLayout")
			if not hasUIList then
				element.Position = UDim2.new(
					OriginalPosition.X.Scale * Scale,
					OriginalPosition.X.Offset * Scale,
					OriginalPosition.Y.Scale * Scale,
					OriginalPosition.Y.Offset * Scale
				)
			end
		end
	end
	...
	local createNotification : (Text : string, Type : string, Duration : number) -> any = nil;
	(function()
		local NScript = {};
		...
		-- StarterGui.ScreenGui.CanvasGroup.UIListLayout
		...
		-- StarterGui.ScreenGui.CanvasGroup.UIPadding
		NScript["4"] = Instance.new("UIPadding", NScript["2"]);
		NScript["4"]["PaddingTop"] = UDim.new(0, 12);
	
	
		-- StarterGui.ScreenGui.CanvasGroup.UIGradient
		NScript["5"] = Instance.new("UIGradient", NScript["2"]);
		NScript["5"]["Rotation"] = 90;
		NScript["5"]["Transparency"] = NumberSequence.new{NumberSequenceKeypoint.new(0.000, 0),NumberSequenceKeypoint.new(0.705, 0),NumberSequenceKeypoint.new(0.823, 1),NumberSequenceKeypoint.new(1.000, 1)};
		...
		local function C_6()
			local Types = {
				Success = {"3aff89", 'rbxassetid://112710982192332'},
				Info = {"46c4ff", 'rbxassetid://110233303954611'},
				Error = {"ff5757", 'rbxassetid://112489485508417'},
				Warn = {"ffc849", 'rbxassetid://140599696565012'},
			}
	
			createNotification = function(text, type, dur)
				task.spawn(function()
					local Noification = {}
					do
						local G2L = Noification
						-- StarterGui.ScreenGui.LocalScript1.N
						...
						-- StarterGui.ScreenGui.LocalScript1.N.UICorner
						G2L["8"] = Instance.new("UICorner", G2L["7"]);
						G2L["8"]["CornerRadius"] = UDim.new(0, 12);
	
	
						-- StarterGui.ScreenGui.LocalScript1.N.UIListLayout
						...
						-- StarterGui.ScreenGui.LocalScript1.N.Bypass
						...
						-- StarterGui.ScreenGui.LocalScript1.N.Bypass.UIListLayout
						...
						-- StarterGui.ScreenGui.LocalScript1.N.Bypass.Icon
						...
						-- StarterGui.ScreenGui.LocalScript1.N.Bypass.Icon.UIAspectRatioConstraint
						G2L["d"] = Instance.new("UIAspectRatioConstraint", G2L["c"]);
	
	
	
						-- StarterGui.ScreenGui.LocalScript1.N.Bypass.UIPadding
						...
						-- StarterGui.ScreenGui.LocalScript1.N.Bypass.Title
						...
						-- StarterGui.ScreenGui.LocalScript1.N.UIStroke
						...
						-- StarterGui.ScreenGui.LocalScript1.N.Misc
						G2L["11"] = Instance.new("Folder", G2L["7"]);
						G2L["11"]["Name"] = [[Misc]];
	
	
						-- StarterGui.ScreenGui.LocalScript1.N.Misc.Fill
					...
					local ATween = game.TweenService:Create(Noification.Animator, TweenInfo.new(0.5, Enum.EasingStyle.Back), {Scale = 1})
					ATween:Play()
					ATween.Completed:Wait()
	
					ATween = game.TweenService:Create(Noification["7"].Misc.Fill, TweenInfo.new(dur, Enum.EasingStyle.Linear), {Size = UDim2.new(0, 0, 0, 4)})
					ATween:Play()
					ATween.Completed:Wait()
	
					ATween = game.TweenService:Create(Noification.Animator, TweenInfo.new(0.1, Enum.EasingStyle.Exponential, Enum.EasingDirection.In), {Scale = 0})
					ATween:Play()
					ATween.Completed:Wait()
	...
	local function load_highlighter()
					--[[
			TYPES
	]]
	...
	--[[
		...
		function utility.getTextBounds(textObject): Vector2
			...
			-- CHANGE: Add timeout and use task.wait() less aggressively
			local attempts = 0
	...
	--[[
		...
		local function UpdateGlobalTypes()
			for _,typer in {_G,(getgenv and getgenv() or {})} do
	...
	--]=]
		...
		local lua_matches = {
			...
			{ Prefix .. BRACKETS .. Suffix, "OPERATORS/BRACKETS-Color" },
					...
					for tokenType, pattern in ipairs(PATTERNS) do
						...
						if rawToken == "var" then
							...
							elseif previousToken == "keyword" and string.match(previousContent1, "function") then
								...
								processedToken = "function_name"  -- New token type
	...
	--[[
		...
		function Highlighter._getLabelingInfo(textObject)
			...
			-- Try to get actual line height from TextBounds if available
			local textHeight
			if textObject.TextBounds.Y > 0 and numLines > 0 then
				textHeight = textObject.TextBounds.Y / numLines
			else
				textHeight = textObject.TextSize * 1.2 -- Fallback
			end
		...
		function Highlighter._alignLabels(textObject)
			...
			alignmentDebounce[textObject] = task.defer(function()
				...
				for lineNumber, lineLabel in labelingInfo.data.Labels do
					...
					lineLabel.AutomaticSize = Enum.AutomaticSize.None -- Don't auto-size labels
	...
	--[[
		...
		function Highlighter.highlight(props): () -> ()
			...
			textObject.TextColor3 = theme.getColor("iden") --Color3.new(255,255,255)
			...
			-- 5. Update the cleanup function to include debounce cleanup:
	...
	local encryptDecrypt = function(data, key)
		local output = {}
	...
	task.spawn(function()
		...
		local function UpdateSize()
			--scaleUIElement(script.Parent.ImageLabel)
	...
	UIEvents = {
		EditorTabs = {
			...
			createTab = function(TabName , Content )
				...
				CLONED_Detectedly.writefile("scripts/"..TabName .. ".lua", game.HttpService:JSONEncode({Name = TabName, Content = Content, Order = HighestOrder + 1}))
				if Data.Editor.Tabs then
					Data.Editor.Tabs[TabName] = {Content, HighestOrder + 1}
				end
				UIEvents.EditorTabs.switchTab(TabName)
				--Data.Editor.CurrentTab  = TabName
				UIEvents.EditorTabs.updateUI()
			end,
			saveTab = function(tabName, Content)
				tabName = tabName or Data.Editor.CurrentTab
				if not tabName then return end  -- Add this check
				local TabData = Data.Editor.Tabs[tabName]
				if TabData and Content then
					CLONED_Detectedly.writefile("scripts/"..tabName.. ".lua", game.HttpService:JSONEncode({Name = tabName, Content = Content, Order = TabData[2]}))
			...
			switchTab = function(ToTab)
				if Data.Editor.Tabs[ToTab] and not Data.Editor.IsSwitching then
					...
					-- Save current tab's content BEFORE doing anything else
					...
					-- Update current tab reference BEFORE loading new content
					Data.Editor.CurrentTab = ToTab
	
	
					-- NOW load new tab's content
					local TabContent = Data.Editor.Tabs[ToTab][1] or ""
					EditorFrame.Text = TabContent
					--Editor:WaitForChild("Editor").CanvasSize = UDim2.new(0, EditorFrame.TextBounds.X + 10, 0, EditorFrame.TextBounds.Y + 10)
					--highlighter.refresh()
		...
		Saved = {
			SaveFile = function(Name, Content)
				...
				CLONED_Detectedly.writefile("saves/"..Name.. ".lua", game.HttpService:JSONEncode({Name = Name, Content = Content}))
	...
	InitTabs.Settings = function()
		...
		local function newToggle(title, callbacl)
			...
			local Enable = false
			do
				local Real = G2L or {d1 = Pages.Settings.Scripts}
				local G2L = Toggles
				-- StarterGui.ScreenGui.Main.Pages.Settings.Scripts.AFK
				G2L["d6"] = Instance.new("CanvasGroup", Real["d1"]);
				G2L["d6"]["Visible"] = true;
				...
				G2L["de"]["BackgroundColor3"] = Color3.fromRGB(69, 72, 85) -- 57, 143, 255); --54, 57, 67
			...
			Toggles["de"].MouseButton1Click:Connect(function()
				...
				Toggles["de"].BackgroundColor3 = Enable and Color3.fromRGB(57, 143, 255) or Color3.fromRGB(69, 72, 85) -- 57, 143, 255); --54, 57, 67
			end)
	...
	InitTabs.TabsData = function()
		...
		for index, Nextpath in ipairs(scripts) do
			...
			Data.Editor.Tabs[Loadedscript.Name] = {Loadedscript.Content, Loadedscript.Order}
		end
		if #scripts == 0 then
	...
	InitTabs.Saved = function()
		...
		for index, Nextpath in ipairs(saves) do
			...
			--createNotification("Loaded " .. Loadedscript.Name .. " " .. Loadedscript.Content, "Success", 5)
		end
		UIEvents.Saved.UpdateUI()
	end
	...
	InitTabs.Editor = function()
		...
		EditorFrame.Input:GetPropertyChangedSignal("Text"):Connect(function()
			...
			--EditorFrame.Input.Text = EditorFrame.Input.Text
		end)	
		update_lines(EditorFrame.Input, EditorFrame.Lines)
	...
	InitTabs.Search = function()
		...
		local verifyicon = utf8.char(0xE000)
		...
		local function Update()
			...
			local scriptJson = if isEmpty then Trending elseif isGame then GameScript else game:HttpGet("https://scriptblox.com/api/script/search?strict=true&q=" .. search .. "&max=20")
	...
	InitTabs.Nav = function()
		...
		local function goTo(Name, f)
			...
			-- Smear frame effect (stretch in direction of movement)
			local SmearAmount = math.min(Distance * 0.8, 100) -- Max stretch of 100 pixels
			local Angle = math.atan2(DeltaY, DeltaX)
	
			-- Create smear size (stretch along movement direction)
			...
			-- Mid position (slightly past halfway for better effect)
			local MidX = StartX + DeltaX * 0.5
			local MidY = StartY + DeltaY * 0.5
			local MidPos = UDim2.new(0, MidX, 0, MidY)
	
			-- Phase 1: Accelerate and stretch (smear)
			local SmearTween = TweenService:Create(
				EnableFrame,
				TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.In),
				{Position = MidPos, Size = SmearSize, BackgroundTransparency = 0.75}
			)
	
			-- Phase 2: Decelerate and return to normal size
		...
		workspace.CurrentCamera:GetPropertyChangedSignal("ViewportSize"):Connect(function()
			goTo(CurrentPage or "Home", true)
		end)
		task.wait(1)
		goTo("Home", true)
	end
	InitTabs.Autoexecute = function()
		-- AUTO Execute + decompiler
		repeat task.wait() until game:IsLoaded() and game.Players.LocalPlayer ~= nil
	...
	local function hideUI(bool, forKey)
		...
		for _, v in ipairs(script.Parent:GetChildren()) do
			if v.Name == "Key" then 
				v.Visible = bool and not KeyVailded
				continue 
			end
			-- Skip EnableFrame from hideUI control
	...
	local function closeUI()
		-- Hide EnableFrame during animation
	...
	local function openUI()
		-- Show all UI elements except EnableFrame
		hideUI(true)
		-- Explicitly show EnableFrame after other elements are visible
	...
	local function dragify(Frame)
		...
		local function updateInput(input)
			...
			game:GetService("TweenService"):Create(Frame, TweenInfo.new(.125), {
				Position = Position
			}):Play()
	...
	--TODO: open ui animations just teleporrt old pos
	--closeUI()
	task.spawn(function() 
		...
		game.Players.LocalPlayer.Chatted:Connect(function(m)
			if m:sub(1, #command):lower() == command and not G2L["1"].Enabled and InvisTriggerOpen then
	...
	local KeyFrame = script.Parent.Key.Main
	...
	local function ValidateKey(Key)
		...
		local DataFetch = (request or
			function()
				return {Success = true, Body = HttpService:JSONEncode({V2_Authentication = "success", Key_Information = {}})}
			end
		)({
			Url = Url,
			Method = "GET"
		...
		if DataFetch.Success then
			...
			if JsonData["V2_Authentication"] == "success" then
				-- Response on success
				print("[Pelinda] Authenticated")
				return true
			else
				print("[Pelinda] Wrong Key")
				return false
			end
		else
			error("[Pelinda] Request failed")
			return false
		end
	end
	...
	local function UpdateExpires(Key)
		local Url = "https://pandadevelopment.net/v2_validation?key=" .. Key .. "&service=" .. Identifier .. "&hwid=" .. UserID
		local DataFetch = (request or function() return {Success = true, Body = HttpService:JSONEncode({V2_Authentication = "success", Key_Information = {}})} end)({
			Url = Url,
			Method = "GET"
		})
		...
		if DataFetch.Success then
			...
			if JsonData["V2_Authentication"] == "success" then
				local KeyFrame = Pages:WaitForChild("Home"):WaitForChild("Key")
				KeyFrame:WaitForChild("KeyText").Text = 'Your keys are currently <font color="rgb(125, 255, 125)">active</font> and will expire on...'
				KeyFrame:WaitForChild("Duration").Text = game.HttpService:JSONDecode(DataFetch.Body).Key_Information.expiresAt
			end
		end
	end
	
	if CLONED_Detectedly.isfile("Key") or Free4Now then
		local Key = CLONED_Detectedly.readfile("Key")
		local Valid = Free4Now or ValidateKey(Key)
		if Valid then
			KeyVailded = true
			script.Parent.Key.Visible = false
			loadUI()
			UpdateExpires(Key or "")
		end
	end
	
	KeyFrame.Button.GetKey.MouseButton1Click:Connect(function()
		local Key = GetKey()
		KeyFrame.Key.Text = Key
		setclipboard(Key)
	end)
	
	KeyFrame.Button.Redeem.MouseButton1Click:Connect(function()
		local Key = KeyFrame.Key.Text
		...
		if Valid then
			...
			script.Parent.Key.Visible = false
			loadUI()
			UIEvents.Key.Save(Key)
			UpdateExpires(Key)
		elseif data.Key_Information then
			KeyFrame.Key.Text = data.Key_Information.Notes
		
		end
	end)
	
	KeyFrame.Join.Activated:Connect(function()
		script.Parent.Key.Visible = false
		hideUI(false)
	end)
end;
